          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
              <div className="bg-white p-6 rounded-2xl shadow-xs border border-border flex items-center justify-between">
                <div>
                  <span className="block text-[9px] font-bold text-text-dim tracking-widest uppercase">Total Fine Accrued</span>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-xs border border-border flex items-center justify-between">
                <div>
                  <span className="block text-[9px] font-bold text-text-dim tracking-widest uppercase">Total Recovered</span>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-xs border border-border flex items-center justify-between">
                <div>
                  <span className="block text-[9px] font-bold text-text-dim tracking-widest uppercase">Pending Recovery</span>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-xs border border-border flex items-center justify-between">
                <div>
                  <span className="block text-[9px] font-bold text-text-dim tracking-widest uppercase">Disputed Tickets</span>
                  ...
                  <table className="w-full border-collapse text-left">
                    <thead>
                      <tr className="border-b border-border bg-slate-50/70">
                        ...
                        <th className="px-6 py-3.5 font-sans text-[10px] font-bold text-text-muted uppercase tracking-wider">Violation Date</th>
                        <th className="px-6 py-3.5 font-sans text-[10px] font-bold text-text-muted uppercase tracking-wider">Challan Number</th>
                        <th className="px-6 py-3.5 font-sans text-[10px] font-bold text-text-muted uppercase tracking-wider">Vehicle Plate</th>
                        <th className="px-6 py-3.5 font-sans text-[10px] font-bold text-text-muted uppercase tracking-wider">Driver Details</th>
                        <th className="px-6 py-3.5 font-sans text-[10px] font-bold text-text-muted uppercase tracking-wider">Govt. Challan (₹)</th>
                        <th className="px-6 py-3.5 font-sans text-[10px] font-bold text-rose-500 uppercase tracking-wider">Internal Fine (₹)</th>
